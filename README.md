...
![App Screenshot](Bug-Tracker-UI.png) ![App Screenshot](Bug-Tracker-UI-2.png)
...
The bug appears in the list with the correct title and status

Actual Result:

![Bug Test](Bug-Tracker-Test-Case.png)

Test:

Create a new bug report with intentional bug

Expected Result:

An alert pops up with a message requesting a field be filled out

Actual Result:

![Bug Test Edge Case](Bug-Tracker-Edge-Case.png)
